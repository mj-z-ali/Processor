...
SLR == [f \in BV64 |-> [g \in BV64 |-> [i \in 0..63 |->
            
           (CMP64[AND64[f][b63]][b63] /\
            (i=0) /\ g[63]
           ) \/ 
           (CMP64[AND64[f][b63]][b62] /\
            ( ((i=0) /\ g[62]) \/ ((i=1) /\ g[63]) ) 
           ) \/ 
           (CMP64[AND64[f][b63]][b61] /\
            ( ((i=0) /\ g[61]) \/ ((i=1) /\ g[62]) \/ ((i=2) /\ g[63]) ) 
           ) \/
           (CMP64[AND64[f][b63]][b60] /\
            ( ((i=0) /\ g[60]) \/ ((i=1) /\ g[61]) \/ ((i=2) /\ g[62]) \/ ((i=3) /\ g[63]) ) 
           ) \/
           (CMP64[AND64[f][b63]][b59] /\
            ( ((i=0) /\ g[59]) \/ ((i=1) /\ g[60]) \/ ((i=2) /\ g[61]) \/ ((i=3) /\ g[62]) \/ ((i=4) /\ g[63]) ) 
           ) \/
           (CMP64[AND64[f][b63]][b58] /\
            ( ((i=0) /\ g[58]) \/ ((i=1) /\ g[59]) \/ ((i=2) /\ g[60]) \/ ((i=3) /\ g[61]) \/ ((i=4) /\ g[62]) \/ ((i=5) /\ g[63])  ) 
           ) \/
           (CMP64[AND64[f][b63]][b57] /\
            ( ((i=0) /\ g[57]) \/ ((i=1) /\ g[58]) \/ ((i=2) /\ g[59]) \/ ((i=3) /\ g[60]) \/ ((i=4) /\ g[61]) \/ ((i=5) /\ g[62])  \/ ((i=6) /\ g[63]) ) 
           ) \/
           (CMP64[AND64[f][b63]][b56] /\
            ( ((i=0) /\ g[56]) \/ ((i=1) /\ g[57]) \/ ((i=2) /\ g[58]) \/ ((i=3) /\ g[59]) \/ ((i=4) /\ g[60]) \/ ((i=5) /\ g[61])  \/ ((i=6) /\ g[62])  \/ ((i=7) /\ g[63]) ) 
           ) \/
       ]]]
...
xR11 == [ i \in 0..63 |-> 
            ...
            (
                \* { (xR8==69) /\ (xR13[0,32]) }
                (CMP64[xR8][[j \in 0..63 |-> (j=0) /\ (j=2) /\ (j=6)]] /\ xR13[i]) \/
                (CMP64[xR8][[j \in 0..63 |-> (j=1) /\ (j=6) /\ (j=7)]] /\ )
...
\* Last modified Thu Dec 08 06:29:06 CST 2022 by mjhomefolder
